...
def main():
    ...
    print("Total Evaluations: 6")
    print("Blocked: 2 (TFN detected)")
    print("Redacted: 1 (Credit card)")
    print("Quarantined: 1 (Financial docs)")
    print("Alerted: 1 (Medical terms)")
    print("Allowed: 1 (Clean content)")
